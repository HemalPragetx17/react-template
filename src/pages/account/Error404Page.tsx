...
const Error404Page = () => {
  return (
    <div className='flex justify-center items-center flex-col h-screen w-full bg-background text-foreground'>
      <div className="mb-10">
        <img
          src={Error404}
          className="max-h-[160px] dark:invert"
          alt="image"
        />
      </div>
      ...
      <div className="text-md text-default-700 mb-10">
